  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMsg = err && typeof err === 'object' && 'response' in err
        ...
        : null
      toast.error(errorMsg || (err as Error)?.message || 'Registration failed')
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="relative w-full max-w-5xl mx-4 my-8 grid lg:grid-cols-2 bg-white border border-[#E8D5A3] shadow-[0_24px_70px_rgba(13,7,0,0.08)] overflow-hidden">
        ...
        <div className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-[10px] font-bold text-[#71531A] uppercase tracking-widest mb-1.5 block">
                Full Name
              </label>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-[#2C2C2C]/70">
              ...
              <Link href="/login" className="text-[#9D7A2E] hover:text-[#340008] font-bold transition-colors underline underline-offset-4">
                Sign In
              </Link>
            </p>
